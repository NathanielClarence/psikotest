...
# Form implementation generated from reading ui file 'aa11.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(915, 200)
        self.nextEx = QtWidgets.QPushButton(Form)
        self.nextEx.setEnabled(False)
        self.nextEx.setGeometry(QtCore.QRect(810, 160, 75, 23))
        self.nextEx.setObjectName("nextEx")
        self.groupBox = QtWidgets.QGroupBox(Form)
        self.groupBox.setGeometry(QtCore.QRect(20, 40, 861, 111))
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(30, 20, 812, 80))
        ...
        self.horizontalLayout.addWidget(self.checkBox_11)
        ...
        self.ttimer = QtWidgets.QLabel(Form)
        self.ttimer.setGeometry(QtCore.QRect(746, 10, 51, 20))
        self.ttimer.setObjectName("ttimer")
        self.startEx = QtWidgets.QPushButton(Form)
        self.startEx.setGeometry(QtCore.QRect(810, 10, 75, 23))
        self.startEx.setObjectName("startEx")
    ...
    def retranslateUi(self, Form):
        ...
        self.nextEx.setText(_translate("Form", "Selesai"))
        self.groupBox.setTitle(_translate("Form", "Soal 11"))
        self.checkBox.setText(_translate("Form", "56"))
        self.checkBox_2.setText(_translate("Form", "48"))
        self.checkBox_3.setText(_translate("Form", "95"))
        self.checkBox_4.setText(_translate("Form", "37"))
        self.checkBox_5.setText(_translate("Form", "88"))
        self.checkBox_6.setText(_translate("Form", "73"))
        self.checkBox_7.setText(_translate("Form", "26"))
        self.checkBox_8.setText(_translate("Form", "45"))
        self.checkBox_9.setText(_translate("Form", "69"))
        self.checkBox_10.setText(_translate("Form", "32"))
        self.checkBox_11.setText(_translate("Form", "84"))
        self.checkBox_12.setText(_translate("Form", "51"))
        self.checkBox_13.setText(_translate("Form", "62"))
        self.checkBox_14.setText(_translate("Form", "91"))
        self.checkBox_15.setText(_translate("Form", "78"))
        self.checkBox_16.setText(_translate("Form", "21"))
        self.ttimer.setText(_translate("Form", "Timer"))
        self.startEx.setText(_translate("Form", "Mulai"))
